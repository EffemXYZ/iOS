...
//        let trackOne = Track(name: "one", duration: 123, streamURL: "", artist: Artist(name: "Tom", image: "", albums: [], tracks: []), album: Album(name: "", releaseDate: .now, image: "", artist: Artist(name: "", image: "", albums: [], tracks: []), tracks: []))
        ...
        let album = Album(name: "Yourself or Someone Like You", releaseDate: .now, image: "https://upload.wikimedia.org/wikipedia/en/4/4e/Matchbox_Twenty_-_Yourself_or_Someone_Like_You.jpg", artist: artist)
